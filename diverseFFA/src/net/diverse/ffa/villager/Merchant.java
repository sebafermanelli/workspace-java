...
import net.diverse.ffa.villager.ReflectionUtils.NMSMerchantRecipe;
...
public class Merchant {
	...
	public Merchant() {
		...
		this.h.obj = Proxy.newProxyInstance(Bukkit.class.getClassLoader(), new Class[] { ReflectionUtils.getClassByName(ReflectionUtils.getNMSPackageName() + ".IMerchant") }, this.h);
	}
